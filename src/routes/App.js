          ...
          <BrowserRouter>
            <div className="main_container">
              ...
              <Switch>
                ...
                <Route exact path="/pokemon/" component={ (props) => <Pokemons {...props} pokemons={pokemons} requestAllPokemonUrl={this.requestAllPokemonUrl.bind(this)} postPerReq={3} initialPost={3}/> }/>
